    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('TUTOR', 'Tutor/Madre/Padre'), ('ADMIN_KINDER', 'Administrador Kinder'), ('SUPERADMIN', 'Super Administrador')], default='TUTOR', max_length=20)),
                ('telefono', models.CharField(blank=True, max_length=20)),
                ('direccion', models.CharField(blank=True, max_length=255)),
                ('foto_perfil', models.ImageField(blank=True, null=True, upload_to='usuarios/perfiles/')),
                ('firebase_token', models.CharField(blank=True, help_text='Token FCM para notificaciones push', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('relacion', models.CharField(choices=[('MADRE', 'Madre'), ('PADRE', 'Padre'), ('ABUELO', 'Abuelo/a'), ('TIO', 'Tío/a'), ('OTRO', 'Otro')], default='MADRE', max_length=20)),
                ...
                ('usuario', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='tutor_profile', to='core.usuario')),
            ],
            options={
                'verbose_name': 'Tutor',
